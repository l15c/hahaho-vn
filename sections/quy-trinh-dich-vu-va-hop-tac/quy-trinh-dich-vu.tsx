...
const data = [
  ...
  { step: 9, description: "Tìm hiểu, tiếp nhận, khảo sát yêu cầu khách hàng " },
  {step:10,  description:"Tìm hiểu, tiếp nhận, khảo sát yêu cầu khách hàng "}
];
const QuyTrinhDichVu = (props: Props) => {
   return (
     <div>
